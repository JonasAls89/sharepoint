...
namespace WebAPI.NetCore.Controllers
{
    ...
    public class TokenController : Controller
    {
        ...
        public TokenController(){
            _username = "kien.nguyen@sesaminternaltesting.onmicrosoft.com";
            _password = "L4DVPJwTZ3XwezypXh@9";
        }
        // POST: api/Token
        [HttpPost]

        public IActionResult Create() => new ObjectResult(GenerateToken(_username, _password));
